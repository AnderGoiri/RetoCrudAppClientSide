...
public class EventRestClient {
    ...
    public <T> T findEventsByONG_JSON(Class<T> responseType, String ongName) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("findEventsByONG/{0}", new Object[]{ongName}));
    ...
    public <T> T findEventsWonByPlayer_XML(Class<T> responseType, String playerId) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("findEventsWonByPlayer/{0}", new Object[]{playerId}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findEventsWonByPlayer_JSON(Class<T> responseType, String playerId) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("findEventsWonByPlayer/{0}", new Object[]{playerId}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
    ...
    public <T> T findEventsByOrganizer_JSON(Class<T> responseType, String organizerName) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("findEventsByOrganizer/{0}", new Object[]{organizerName}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
    ...
    public <T> T findEventsByGame_JSON(Class<T> responseType, String gameName) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("findEventsByGame/{0}", new Object[]{gameName}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }

    public <T> T findEventsWonByTeam_XML(Class<T> responseType, String teamName) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("findEventsWonByTeam/{0}", new Object[]{teamName}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findEventsWonByTeam_JSON(Class<T> responseType, String teamName) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("findEventsWonByTeam/{0}", new Object[]{teamName}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
