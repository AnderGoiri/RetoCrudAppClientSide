...
/**
 * The {@code GameManager} interface defines the contract for managing
 * game-related functionality in the eSports application. It extends the
 * {@code ESportsManager} interface and specifies methods for CRUD operations on
 * games, as well as additional search functionality.
 *
 * <p>
 * Implementations of this interface provide the concrete logic for the
 * specified functionality.</p>
 *
 * <p>
...
public interface GameManager extends ESportsManager {
     ...
     * @return a Collection of {@code Game} objects matching the specified
     * genre.
     *
     * @throws BusinessLogicException if there is any error while processing.
     *
     ...
     * @return a Collection of {@code Game} objects matching the specified PVP
     * type.
     *
     * @throws BusinessLogicException if there is any error while processing.
     *
     ...
     * @return a Collection of {@code Game} objects created by the specified
     * admin.
     *
     * @throws BusinessLogicException if there is any error while processing.
     *
